...
<aside
    ...
    <div>
        <h3>Author</h3>
        <ul>
                <x-side-item :href="route('dashboard')" icon="fa-solid fa-objects-column" :active="Route::is('dashboard')">
                    Dashboard
                </x-side-item>
                <x-side-item :href="route('article.index')" icon="fa-solid fa-file" :active="Route::is('article*')">
                    Posts
                </x-side-item>
                <x-side-item href="{{ route('profile') }}" icon="fa-solid fa-user" :active="Route::is('profile')">
                    Profile
                </x-side-item>
            </ul>
        @can('admin')
        <h3>Admin</h3>
        <ul>
            <x-side-item href="{{ route('users.index') }}" icon="fa-solid fa-users" :active="Route::is('users*')">
                Users
            </x-side-item>
            <x-side-item href="{{ route('all_articles') }}" icon="fa-solid fa-copy" :active="Route::is('all_articles')">
                All Posts
            </x-side-item>
            <x-side-item href="{{ route('category.index') }}" icon="fa-solid fa-folder" :active="Route::is('category.index')">
                Categories
            </x-side-item>
            <x-side-item href="{{ url('/') }}" icon="fa-solid fa-rectangle-ad" :active="Route::is('category.index')">
                Adverticements
            </x-side-item>
        </ul>
        @endcan
        ...
        <h3>Developer</h3>
        <ul>
            <x-side-item href="{{ url('/') }}" icon="fa-solid fa-browser" >
                Developer
            </x-side-item>
