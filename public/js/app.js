...
var toggleDark = document.querySelectorAll('[data-toggle="toggle-dark"]');
var expand = document.querySelectorAll("#expand");
var sidebar = document.getElementById("sidebar");
expand.forEach(function (x) {
...
toggleDark.forEach(function (item) {
  item.addEventListener("click", function () {
    ...
    item.innerHTML = localStorage.theme === "light" ? '<i class="fas fa-sun"></i>' : '<i class="fas fa-moon"></i>';
